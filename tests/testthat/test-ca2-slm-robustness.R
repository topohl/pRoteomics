...
testthat::test_that("no FDR is recomputed and no model is refitted", {
  for (f in list(c("analysis/03_spatial_validation", "audit_ca2_slm_robustness.R"),
                 c("analysis/03_spatial_validation", "audit_stress_identity_robustness.R"),
...
testthat::test_that("imputation status comes from pre-imputation missingness", {
  s <- code_of("analysis/03_spatial_validation", "audit_ca2_slm_robustness.R")
...
testthat::test_that("the stress-identity comparison uses explicit subsets and the canonical rule", {
  ...
  s <- code_of("analysis/03_spatial_validation", "audit_stress_identity_robustness.R")
