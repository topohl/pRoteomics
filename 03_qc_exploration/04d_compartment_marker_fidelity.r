...
#
# Reads marker score tables from 04c_marker_detectability_and_wgcna_bridge.r
# and produces compact soma/neuropil/microglia marker plots across the three
# active compartment datasets. This is QC/interpreter support, not formal purity
# estimation or deconvolution.
...
write_run_manifest(
  ...
  notes = "Cross-dataset soma/neuropil/microglia marker fidelity QC from 04c marker_detectability_by_sample.csv outputs."
)
