...
73. `08_behavior_physio_coupling/01_correlate_proteomics_with_behavior.r` - stage `coupling`; scope `dataset_specific`
74. `08_behavior_physio_coupling/02_network_behavior_coupling.r` - stage `coupling`; scope `dataset_specific`
75. `08_behavior_physio_coupling/03_module_behavior_coupling.r` - stage `coupling`; scope `dataset_specific`
76. `10_biological_integration/01_cross_compartment_program_atlas.r` - stage `integration`; scope `global`
77. `10_biological_integration/02_manuscript_program_summary.r` - stage `integration`; scope `global`
78. `09_export_pride_journal/07_make_biological_claims_table.R` - stage `integration`; scope `global`
79. `10_biological_integration/03_evidence_priority_matrix.r` - stage `integration`; scope `global`
80. `10_biological_integration/05_gsea_wgcna_concordance.R` - stage `integration`; scope `global`
81. `10_biological_integration/06_gsea_wgcna_concordance_diagnostics.R` - stage `integration`; scope `global`
82. `10_biological_integration/08_wgcna_candidate_protein_shortlist.R` - stage `integration`; scope `per_dataset_and_global`
83. `10_biological_integration/09_wgcna_sus_res_network_position.R` - stage `integration`; scope `per_dataset_and_global`
84. `10_biological_integration/04_wgcna_circular_atlas.R` - stage `integration`; scope `global`
85. `10_biological_integration/04_wgcna_cross_compartment_overview.R` - stage `integration`; scope `global`
86. `10_biological_integration/05_manuscript_figure3_wgcna_protein_zoom.R` - stage `integration`; scope `global`
87. `figures/figure_02.R` - stage `integration`; scope `global`
88. `figures/figure_03.R` - stage `integration`; scope `global`
89. `09_export_pride_journal/02_make_sample_metadata.R` - stage `export`; scope `global`
90. `09_export_pride_journal/03_export_processed_pg_matrix_package.R` - stage `export`; scope `global`
91. `09_export_pride_journal/04_make_supplementary_tables.R` - stage `export`; scope `global`
92. `09_export_pride_journal/05_make_pride_manifest.R` - stage `export`; scope `global`
93. `09_export_pride_journal/06_make_methods_summary.R` - stage `export`; scope `global`
94. `09_export_pride_journal/08_export_manuscript_figures.R` - stage `export`; scope `global`
95. `09_export_pride_journal/09_export_source_data.R` - stage `export`; scope `global`
96. `09_export_pride_journal/10_validate_pride_submission.R` - stage `export`; scope `global`
