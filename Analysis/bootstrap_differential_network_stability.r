...
params <- list(
  # Spatial RDS generated by Analysis/network_spatial_relations.r
  ...
  #output_dir = "S:/Lab_Member/Tobi/Experiments/Exp9_Social-Stress/proteomics/Results/bootstrap_differential_network_stability",
  output_dir = "/Users/tobiaspohl/Documents/pRoteomics/Results/bootstrap_differential_network_stability",
