...
# -------------------------------
params <- list(
  # Spatial proteomics RDS generated by Analysis/network_spatial_relations.r
  ...
  # MMMSociability GAMM AUC output. The first active/first cage-change table is
  # the most relevant candidate for your predictive movement phenotype.
  #movement_auc_file = "S:/Lab_Member/Tobi/Experiments/Exp9_Social-Stress/Analysis/Behavior/RFID/statistics/gamm_new/analyses/gamm/tables/auc_individual_animals_firstChangeActive.csv",
  movement_auc_file = "/Users/tobiaspohl/Documents/Data/Behavior/RFID/statistics/gamm_new/analyses/gamm/tables/auc_individual_animals_firstChangeActive.csv",

  # Optional second movement table, if present. Used for sensitivity outputs.
  #movement_auc_all_file = "S:/Lab_Member/Tobi/Experiments/Exp9_Social-Stress/Analysis/Behavior/RFID/statistics/gamm_new/analyses/gamm/tables/auc_individual_animals_all.csv",
  movement_auc_all_file = "/Users/tobiaspohl/Documents/Data/Behavior/RFID/statistics/gamm_new/analyses/gamm/tables/auc_individual_animals_all.csv",

  # Behavioral/physiology Excel file used in MMMSociability correlate_activity_physiology.R
  #behavior_xlsx = "S:/Lab_Member/Tobi/Experiments/Exp9_Social-Stress/Analysis/SIS_Analysis/E9_Behavior_Data.xlsx",
  behavior_xlsx = "/Users/tobiaspohl/Documents/Data/Behavior/E9_Behavior_Data.xlsx",
  behavior_sheet = "zScore",

  # Output directory
  #output_dir = "S:/Lab_Member/Tobi/Experiments/Exp9_Social-Stress/proteomics/Results/network_behavior_coupling",
  output_dir = "/Users/tobiaspohl/Documents/pRoteomics/Results/network_behavior_coupling",
...
make_dirs <- function(base_dir) {
  dirs <- list(
    ...
    logs = file.path(base_dir, "03_Logs")
  )
