...
output_dir <- "S:/Lab_Member/Tobi/Experiments/Exp9_Social-Stress/proteomics/Results/pca_plots"
#gct_file <- "S:/Lab_Member/Tobi/Experiments/Collabs/Neha/clusterProfiler/Datasets/gct/data/pg.matrix_filtered_pcaAdjusted_unnormalized.gct"
...
if ("celltype" %in% colnames(meta)) plot_and_save_group("celltype", "PCA", "pca_by_celltype.svg")
if ("region" %in% colnames(meta)) plot_and_save_group("region", "PCA", "pca_by_region.svg")
if ("ExpGroup" %in% colnames(meta)) plot_and_save_group("ExpGroup", "PCA", "pca_by_ExpGroup.svg")
if ("phenotypeWithinUnit" %in% colnames(meta)) plot_and_save_group("phenotypeWithinUnit", "PCA", "pca_by_phenotypeWithinUnit.svg")
