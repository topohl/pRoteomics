...
| SUS-RES biological inspection summary | downstream-only ontology-mapped theme with original representative ranked-GSEA term plus ProteinGroupID DAP count; directional recurrence and Wang similarity are descriptive | `results/tables/04_differential_expression_enrichment/sus_res_spatial_dap_atlas/global/sus_res_manuscript_theme_summary.csv` |
