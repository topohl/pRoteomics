...
WGCNA supermodule biological annotation may include recommended composition-label columns such as `Supermodule_ConservativeLabel`, `Supermodule_CompositionLabel`, `Supermodule_CompositionConfidence`, member-theme fractions, and top member labels/GO terms. These are display and audit aids derived from member-module biological labels/GO terms; they do not redefine supermodules as independently discovered pathways.
