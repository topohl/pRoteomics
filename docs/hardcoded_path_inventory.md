...
- `06_modules_WGCNA/01_WGCNA.r`: central WGCNA model producer; canonical entrypoint in the active registry.
- `06_modules_WGCNA/06_module_spatial_networks.r`: legacy optional helper; no committed active machine path remains.
