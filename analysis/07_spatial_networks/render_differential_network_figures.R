# ================================================================
# Script: analysis/07_spatial_networks/render_differential_network_figures.R
# Stage: networks
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/07_spatial_networks/render_differential_network_figures.R
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/07_spatial_networks/render_differential_network_figures.R")
