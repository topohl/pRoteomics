# ================================================================
# Script: analysis/07_spatial_networks/build_spatial_networks.R
# Stage: networks
...
SCRIPT_ID <- "analysis/07_spatial_networks/build_spatial_networks.R"
...
dry_run_validate <- function(params) {
  ...
  dry_run_line("Script", "analysis/07_spatial_networks/build_spatial_networks.R")
