# ================================================================
# Script: analysis/07_spatial_networks/test_differential_network_stability.R
# Stage: networks
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/07_spatial_networks/test_differential_network_stability.R
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/07_spatial_networks/test_differential_network_stability.R")
