# ================================================================
# Script: analysis/07_spatial_networks/03_bootstrap_network_stability.r
# Stage: networks
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/07_spatial_networks/03_bootstrap_network_stability.r
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/07_spatial_networks/03_bootstrap_network_stability.r")
