...
if (dry_run) {
  ...
  dry_run_line("Script", "analysis/qc/build_reference_marker_registry.R")
...
fallback_registry <- dplyr::bind_rows(lapply(names(canonical_marker_panels), function(ms) {
  ...
  data.frame(
    ...
    source_reference = "analysis/qc/build_reference_marker_registry.R curated conservative fallback",
