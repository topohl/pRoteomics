...
#   audit (analysis/wgcna/audit_module_label_coherence.R) is strictly
#   phenotype-blind and must never consume this script's outputs.
#
# USAGE
#   Rscript analysis/integration/quantify_candidate_network_position.R
#   Rscript analysis/integration/quantify_candidate_network_position.R --dataset microglia
#   Rscript analysis/integration/quantify_candidate_network_position.R --permutations 20000
#   Rscript analysis/integration/quantify_candidate_network_position.R --dry-run
...
SCRIPT_ID <- "analysis/integration/quantify_candidate_network_position.R"
