...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/integration/test_network_behaviour_coupling.R
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/integration/test_network_behaviour_coupling.R")
