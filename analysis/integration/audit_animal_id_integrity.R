...
#
# USAGE
#   Rscript analysis/integration/audit_animal_id_integrity.R
#   Rscript analysis/integration/audit_animal_id_integrity.R --dry-run
...
SCRIPT_ID <- "analysis/integration/audit_animal_id_integrity.R"
...
consumers <- tibble::tribble(
  ...
  "analysis/integration/test_network_behaviour_coupling.R", "normalize_animal_id", 312L,
  ...
  "analysis/integration/test_network_behaviour_coupling.R", "normalize_animal_id", 434L,
  ...
  "analysis/integration/test_network_behaviour_coupling.R", "normalize_animal_id", 464L,
  ...
  "analysis/wgcna/score_module_activity.R", "normalize_animal_id", 2083L,
  ...
  "analysis/integration/test_behaviour_proteomics_associations.R", "normalize_mouse_id", 304L,
