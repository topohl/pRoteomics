...
#
# USAGE
#   Rscript analysis/integration/build_candidate_protein_shortlist.R
#   Rscript analysis/integration/build_candidate_protein_shortlist.R --dataset microglia
#   Rscript analysis/integration/build_candidate_protein_shortlist.R --dataset neuron_neuropil --module WGCNA_m02
#   Rscript analysis/integration/build_candidate_protein_shortlist.R --dry-run
...
SCRIPT_ID <- "analysis/integration/build_candidate_protein_shortlist.R"
...
write_workbook <- function(path, scope, summary_tbl, top10, by_dataset) {
  ...
  wb <- openxlsx::createWorkbook(creator = "analysis/integration/build_candidate_protein_shortlist.R")
