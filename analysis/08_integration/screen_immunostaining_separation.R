#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/08_integration/screen_immunostaining_separation.R
# Stage: integration
...
# Produces: results/source_data/10_biological_integration/immunostaining_separation_screen/.
