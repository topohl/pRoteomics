...
#   audit (analysis/05_wgcna/audit_module_label_coherence.R) is strictly
#   phenotype-blind and must never consume this script's outputs.
#
# USAGE
#   Rscript analysis/08_integration/quantify_candidate_network_position.R
#   Rscript analysis/08_integration/quantify_candidate_network_position.R --dataset microglia
#   Rscript analysis/08_integration/quantify_candidate_network_position.R --permutations 20000
#   Rscript analysis/08_integration/quantify_candidate_network_position.R --dry-run
# Script: analysis/08_integration/quantify_candidate_network_position.R
# Stage: integration
...
SCRIPT_ID <- "analysis/08_integration/quantify_candidate_network_position.R"
