...
#
# USAGE
#   Rscript analysis/08_integration/audit_animal_id_integrity.R
#   Rscript analysis/08_integration/audit_animal_id_integrity.R --dry-run
# Script: analysis/08_integration/audit_animal_id_integrity.R
# Stage: coupling
# Scope: global
...
SCRIPT_ID <- "analysis/08_integration/audit_animal_id_integrity.R"
...
consumers <- tibble::tribble(
  ...
  "analysis/08_integration/test_network_behaviour_coupling.R", "normalize_animal_id", 312L,
  ...
  "analysis/08_integration/test_network_behaviour_coupling.R", "normalize_animal_id", 434L,
  ...
  "analysis/08_integration/test_network_behaviour_coupling.R", "normalize_animal_id", 464L,
  ...
  "analysis/05_wgcna/score_module_activity.R", "normalize_animal_id", 2083L,
  ...
  "analysis/08_integration/test_behaviour_proteomics_associations.R", "normalize_mouse_id", 304L,
