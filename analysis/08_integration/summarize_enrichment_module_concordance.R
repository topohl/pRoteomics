#!/usr/bin/env Rscript
# Script: analysis/08_integration/summarize_enrichment_module_concordance.R
# Stage: additive diagnostic review of test_enrichment_module_concordance.R
#
...
SCRIPT_ID <- "analysis/08_integration/summarize_enrichment_module_concordance.R"
