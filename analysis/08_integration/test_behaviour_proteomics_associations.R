# ================================================================
# Script: analysis/08_integration/test_behaviour_proteomics_associations.R
# Stage: coupling
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/08_integration/test_behaviour_proteomics_associations.R")
