# ================================================================
# Script: analysis/08_integration/test_network_behaviour_coupling.R
# Stage: coupling
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/08_integration/test_network_behaviour_coupling.R
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/08_integration/test_network_behaviour_coupling.R")
