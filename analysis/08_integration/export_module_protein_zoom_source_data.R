...
# is fitted here.
# Script: analysis/08_integration/export_module_protein_zoom_source_data.R
# Stage: integration
# Scope: global
...
inventory <- tibble(figure = "3", panel = c("3a", "3b", "3c", "3d"), question = c("SUS-RES spatial DAP atlas", "Complete Neuropil WGCNA module landscape across the three canonical global contrasts.", "Focused Neuropil supermodule GO-BP member-module evidence.", "Protein-level spatial zoom-ins for selected biologically interpretable WGCNA modules."),
                    renderer = c("analysis/04_differential_abundance/build_sus_res_dap_atlas.R", "analysis/08_integration/export_module_protein_zoom_source_data.R", "analysis/05_wgcna/render_module_go_heatmaps.R", "analysis/08_integration/export_module_protein_zoom_source_data.R"),
