# ================================================================
# Script: analysis/01_preprocessing/map_protein_identifiers.R
# Stage: core
...
if (is_dry_run()) {
    ...
    dry_run_line("Script", "analysis/01_preprocessing/map_protein_identifiers.R")
    ...
    if (!dir.exists(raw_dir) || length(csv_files) == 0) {
        dry_run_line("Required upstream step", "Rscript analysis/01_preprocessing/extract_protigy_contrasts.R without --dry-run")
    }
