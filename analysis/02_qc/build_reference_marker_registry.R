#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/02_qc/build_reference_marker_registry.R
# Stage: qc_global
# Scope: global
...
if (dry_run) {
  ...
  dry_run_line("Script", "analysis/02_qc/build_reference_marker_registry.R")
...
fallback_registry <- dplyr::bind_rows(lapply(names(canonical_marker_panels), function(ms) {
  ...
  data.frame(
    ...
    source_reference = "analysis/02_qc/build_reference_marker_registry.R curated conservative fallback",
