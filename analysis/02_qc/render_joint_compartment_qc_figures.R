...
# unchanged from assess_joint_compartment_quality.R.
# Script: analysis/02_qc/render_joint_compartment_qc_figures.R
# Stage: qc_global
# Scope: global
...
if (length(missing_inputs)) {
  stop("Missing completed joint-QC input(s): ", paste(names(missing_inputs), collapse = ", "), ". Run assess_joint_compartment_quality.R first.", call. = FALSE)
}
