#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/09_publication_exports/10_validate_pride_submission.R
# Stage: export
# Scope: global
...
if (isTRUE(cli$dry_run)) {
  dry_run_line("Script", "analysis/09_publication_exports/10_validate_pride_submission.R")
