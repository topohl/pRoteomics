...
#
# USAGE
#   Rscript analysis/03_spatial_validation/summarize_spatial_atlas.R
# Script: analysis/03_spatial_validation/summarize_spatial_atlas.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/summarize_spatial_atlas.R"
