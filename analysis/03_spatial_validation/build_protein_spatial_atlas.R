...
#
# USAGE
#   Rscript analysis/03_spatial_validation/build_protein_spatial_atlas.R
#   Rscript analysis/03_spatial_validation/build_protein_spatial_atlas.R --dry-run
# Script: analysis/03_spatial_validation/build_protein_spatial_atlas.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/build_protein_spatial_atlas.R"
...
#
# Produced by analysis/03_spatial_validation/audit_stress_identity_robustness.R, which runs
