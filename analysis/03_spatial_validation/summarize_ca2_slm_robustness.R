...
#
# USAGE
#   Rscript analysis/03_spatial_validation/summarize_ca2_slm_robustness.R
#   Rscript analysis/03_spatial_validation/summarize_ca2_slm_robustness.R --dry-run
# Script: analysis/03_spatial_validation/summarize_ca2_slm_robustness.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/summarize_ca2_slm_robustness.R"
...
scan_files <- c(
  ...
  repo_path("analysis/03_spatial_validation", "audit_ca2_slm_robustness.R"),
  repo_path("analysis/03_spatial_validation", "audit_stress_identity_robustness.R"))
offending <- character()
for (f in scan_files) {
