...
#   analysis/03_spatial_validation/build_protein_spatial_atlas.R are read and tabulated
...
#
# USAGE
#   Rscript analysis/03_spatial_validation/audit_stress_identity_robustness.R
#   Rscript analysis/03_spatial_validation/audit_stress_identity_robustness.R --dry-run
# Script: analysis/03_spatial_validation/audit_stress_identity_robustness.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/audit_stress_identity_robustness.R"
...
summarise_subset <- function(label, sel, note) {
  ...
  data.frame(
    ...
    classification_source = "canonical labels from build_protein_spatial_atlas.R, tabulated not recomputed",
