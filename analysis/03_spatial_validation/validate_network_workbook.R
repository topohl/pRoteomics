...
#
# USAGE
#   Rscript analysis/03_spatial_validation/validate_network_workbook.R
# Script: analysis/03_spatial_validation/validate_network_workbook.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/validate_network_workbook.R"
...
beh_src <- repo_path("analysis/08_integration", "test_network_behaviour_coupling.R")
beh_rows <- list()
