...
#
# USAGE
#   Rscript analysis/03_spatial_validation/15_network_legacy_workbook_validation.R
...
SCRIPT_ID <- "analysis/03_spatial_validation/15_network_legacy_workbook_validation.R"
