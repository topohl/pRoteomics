...
#
# USAGE
#   Rscript analysis/03_spatial_validation/audit_ca2_slm_robustness.R
#   Rscript analysis/03_spatial_validation/audit_ca2_slm_robustness.R --dry-run
# Script: analysis/03_spatial_validation/audit_ca2_slm_robustness.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/audit_ca2_slm_robustness.R"
