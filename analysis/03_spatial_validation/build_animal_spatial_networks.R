...
#
# USAGE
#   Rscript analysis/03_spatial_validation/build_animal_spatial_networks.R
#   Rscript analysis/03_spatial_validation/build_animal_spatial_networks.R --dry-run
# Script: analysis/03_spatial_validation/build_animal_spatial_networks.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/build_animal_spatial_networks.R"
