...
#
# USAGE
#   Rscript analysis/03_spatial_validation/build_module_spatial_atlas.R
#   Rscript analysis/03_spatial_validation/build_module_spatial_atlas.R --dry-run
# Script: analysis/03_spatial_validation/build_module_spatial_atlas.R
# Stage: networks
# Scope: per_dataset
...
SCRIPT_ID <- "analysis/03_spatial_validation/build_module_spatial_atlas.R"
