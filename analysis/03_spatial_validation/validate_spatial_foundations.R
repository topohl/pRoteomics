...
#
# USAGE
#   Rscript analysis/03_spatial_validation/validate_spatial_foundations.R
# Script: analysis/03_spatial_validation/validate_spatial_foundations.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/validate_spatial_foundations.R"
...
add("no_wgcna_state_changes", TRUE,
    if (!touches("analysis/05_wgcna/build_wgcna_modules.R") &&
