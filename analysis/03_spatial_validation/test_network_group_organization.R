...
#
# USAGE
#   Rscript analysis/03_spatial_validation/test_network_group_organization.R
#   Rscript analysis/03_spatial_validation/test_network_group_organization.R --dry-run
# Script: analysis/03_spatial_validation/test_network_group_organization.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/test_network_group_organization.R"
