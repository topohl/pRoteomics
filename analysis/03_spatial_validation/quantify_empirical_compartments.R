...
#
# USAGE
#   Rscript analysis/03_spatial_validation/quantify_empirical_compartments.R
#   Rscript analysis/03_spatial_validation/quantify_empirical_compartments.R --dry-run
# Script: analysis/03_spatial_validation/quantify_empirical_compartments.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/quantify_empirical_compartments.R"
