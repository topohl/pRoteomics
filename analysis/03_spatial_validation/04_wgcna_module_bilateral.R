...
#
# USAGE
#   Rscript 11_spatial_systems/04_wgcna_module_bilateral.R
#   Rscript 11_spatial_systems/04_wgcna_module_bilateral.R --dry-run
...
SCRIPT_ID <- "11_spatial_systems/04_wgcna_module_bilateral.R"
