...
#
# USAGE
#   Rscript analysis/03_spatial_validation/04_wgcna_module_bilateral.R
#   Rscript analysis/03_spatial_validation/04_wgcna_module_bilateral.R --dry-run
...
SCRIPT_ID <- "analysis/03_spatial_validation/04_wgcna_module_bilateral.R"
