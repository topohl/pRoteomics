...
#
# USAGE
#   Rscript analysis/03_spatial_validation/quantify_neuropil_precision.R
# Script: analysis/03_spatial_validation/quantify_neuropil_precision.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/03_spatial_validation/quantify_neuropil_precision.R"
