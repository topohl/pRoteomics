...
#
# USAGE
#   Rscript analysis/03_spatial_validation/annotate_module_celltypes.R
#   Rscript analysis/03_spatial_validation/annotate_module_celltypes.R --dry-run
#   Rscript analysis/03_spatial_validation/annotate_module_celltypes.R --reps 1000
# Script: analysis/03_spatial_validation/annotate_module_celltypes.R
# Stage: networks
# Scope: per_dataset
...
SCRIPT_ID <- "analysis/03_spatial_validation/annotate_module_celltypes.R"
