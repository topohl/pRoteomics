#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/04_differential_abundance/08_external_stress_disease_signature_overlap.r
# Stage: enrichment
# Scope: global
...
SCRIPT_ID <- "analysis/04_differential_abundance/08_external_stress_disease_signature_overlap.r"
