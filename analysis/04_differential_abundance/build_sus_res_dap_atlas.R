...
# Script: analysis/04_differential_abundance/build_sus_res_dap_atlas.R
# Stage: enrichment
# Scope: global
...
if (!file.exists(RANKED_PROGRAM_SOURCE)) {
  stop(
    ...
    ". Run analysis/04_differential_abundance/build_go_program_atlas.R first; script 10 does not recompute ranked GO/GSEA statistics.",
    call. = FALSE
  )
}
