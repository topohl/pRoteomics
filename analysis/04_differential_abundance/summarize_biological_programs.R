...
# ================================================================
# Script: analysis/04_differential_abundance/summarize_biological_programs.R
# Stage: enrichment
...
SCRIPT_ID <- "analysis/04_differential_abundance/summarize_biological_programs.R"
...
if (is_dry_run()) {
  ...
  dry_run_line("Script", "analysis/04_differential_abundance/summarize_biological_programs.R")
