# ================================================================
# Script: analysis/04_differential_abundance/compare_go_enrichment.R
# Stage: enrichment
...
if (!file.exists(manifest_path)) {
  stop("clusterProfiler manifest not found: ", manifest_path,
    "\nRun analysis/04_differential_abundance/run_clusterprofiler_enrichment.R first.", call. = FALSE)
}
...
if (isTRUE(DRY_RUN)) {
  ...
  dry_run_line("Script", "compare_go_enrichment.R")
...
if (ncol(cluster_manifest) == 0 ||
  ...
  stop("clusterProfiler manifest is empty or malformed: ", manifest_path,
       "\nRerun analysis/04_differential_abundance/run_clusterprofiler_enrichment.R, or rebuild the manifest from existing source-data outputs.",
       call. = FALSE)
}
