# ================================================================
# Script: analysis/04_differential_abundance/run_clusterprofiler_enrichment.R
# Stage: enrichment
...
#'   - clusterProfiler_manifest.csv consumed by compare_go_enrichment.R
#' Contract:
...
if (isTRUE(DRY_RUN)) {
  ...
  dry_run_line("Script", "run_clusterprofiler_enrichment.R")
