#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/04_differential_abundance/compare_external_stress_signatures.R
# Stage: enrichment
# Scope: global
...
SCRIPT_ID <- "analysis/04_differential_abundance/compare_external_stress_signatures.R"
