# PRIDE and journal export (`analysis/publication_source_data`)
...
```bash
Rscript analysis/publication_source_data/build_sample_metadata.R --dataset microglia
Rscript analysis/publication_source_data/export_processed_matrices.R --dataset microglia
Rscript analysis/publication_source_data/build_supplementary_tables.R --dataset microglia
Rscript analysis/publication_source_data/build_pride_manifest.R --dataset microglia
...
```bash
Rscript analysis/publication_source_data/build_pride_manifest.R --dataset microglia --include-derived-results
Rscript analysis/publication_source_data/build_pride_manifest.R --dataset microglia --recursive
```
