#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/publication_source_data/build_sample_metadata.R
# Stage: export
# Scope: global
# Consumes: required data/metadata/; optional analysis/publication_source_data/config/export_config.yml.
...
if (!nrow(meta_raw)) {
  if (isTRUE(cli$dry_run)) {
    dry_run_line("Script", "analysis/publication_source_data/build_sample_metadata.R")
