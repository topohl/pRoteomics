...
# Script: analysis/05_wgcna/render_microglia_module_figures.R
# Stage: modules_downstream
# Scope: dataset_specific
# Consumes: required results/tables/06_modules_WGCNA/interpretable_summary/microglia/WGCNA_final_label_lookup.csv; results/tables/06_modules_WGCNA/group_effects/microglia/all_supermodule_eigengene_group_values.csv; results/tables/06_modules_WGCNA/interpretable_summary/microglia/WGCNA_inferential_handoff.csv; +7 more; optional none declared in pipeline.yml
# Produces: results/figures/06_modules_WGCNA/wgcna_publication_figures_corrected/microglia/corrected_all_supermodule_architecture.svg; results/figures/06_modules_WGCNA/wgcna_publication_figures_corrected/microglia/corrected_all_supermodule_architecture.pdf; results/figures/06_modules_WGCNA/wgcna_publication_figures_corrected/microglia/corrected_all_supermodule_global_eigengenes.svg; +21 more
# Dataset behavior: runs for microglia according to pipeline.yml and --dataset/PROTEOMICS_DATASET where supported.
# Notes: Corrected additive microglia WGCNA publication layer.
