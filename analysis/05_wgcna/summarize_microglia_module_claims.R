...
# Script: analysis/05_wgcna/summarize_microglia_module_claims.R
# Stage: modules_downstream
# Scope: dataset_specific
# Consumes: required results/reviewer_audit/microglia_wgcna_nature_readiness/; optional none declared in pipeline.yml
# Produces: results/reviewer_audit/microglia_wgcna_nature_readiness/finalization_validation.csv
# Dataset behavior: runs for microglia according to pipeline.yml and --dataset/PROTEOMICS_DATASET where supported.
# Notes: Finalizes only the additive audit manifest after portable HTML packaging.
