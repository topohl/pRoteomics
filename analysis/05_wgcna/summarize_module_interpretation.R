#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/05_wgcna/summarize_module_interpretation.R
...
#
# Design intent:
#   - keep the primary inference from test_module_phenotypes.R
#   - join biological annotation from annotate_module_microenvironment.R
...
program_label_col <- function(df, level = "supermodule") {
  if (level == "supermodule") {
    ...
    # Display labels should prefer the annotation table from annotate_module_microenvironment.R.
