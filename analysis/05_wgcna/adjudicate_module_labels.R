...
#
# USAGE
#   Rscript analysis/05_wgcna/adjudicate_module_labels.R
#   Rscript analysis/05_wgcna/adjudicate_module_labels.R --dataset neuron_neuropil
#   Rscript analysis/05_wgcna/adjudicate_module_labels.R --dry-run
# Script: analysis/05_wgcna/adjudicate_module_labels.R
# Stage: networks
# Scope: per_dataset
...
SCRIPT_ID <- "analysis/05_wgcna/adjudicate_module_labels.R"
