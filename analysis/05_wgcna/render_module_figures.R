#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/05_wgcna/render_module_figures.R
...
# Notes: canonical lookup produced by Stage 07.
# ================================================================
...
if (run$dry_run) {
  dry_run_line("Script", "analysis/05_wgcna/render_module_figures.R")
