# ================================================================
# Script: analysis/05_wgcna/build_curated_overlap_programs.R
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/05_wgcna/build_curated_overlap_programs.R
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/05_wgcna/build_curated_overlap_programs.R")
