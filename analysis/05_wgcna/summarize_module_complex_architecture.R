#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/05_wgcna/summarize_module_complex_architecture.R
...
# Notes: Registered in pipeline.yml stage modules_downstream; declares 3 output path(s).
# ================================================================
...
SCRIPT_ID <- "analysis/05_wgcna/summarize_module_complex_architecture.R"
