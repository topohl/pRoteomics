...
# ================================================================
# Script: analysis/05_wgcna/score_module_activity.R
...
#   - UniProt mapping and source-scoped WGCNA or curated overlap program definitions
# Produces:
# ================================================================
#   - module score tables, QC workbooks, figures and source data in canonical folders
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/05_wgcna/score_module_activity.R
# ================================================================
...
SCRIPT_ID <- "analysis/05_wgcna/score_module_activity.R"
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/05_wgcna/score_module_activity.R")
  ...
  dry_run_line("Inference role", "secondary robustness/program scoring; primary WGCNA eigengene group effects come from analysis/05_wgcna/test_module_phenotypes.R")
...
module_score_role_note <- "Secondary module/program scoring and behavior-coupling layer. Primary WGCNA module and supermodule CON/RES/SUS inference uses eigengene models from analysis/05_wgcna/test_module_phenotypes.R."
module_score_run_metadata <- tibble::tibble(
  ...
  primary_wgcna_inference_script = "analysis/05_wgcna/test_module_phenotypes.R",
...
if (length(missing_inputs) > 0) {
  ...
  hint_lines <- c(
    ...
    "- Merged module-score metadata: source('analysis/01_preprocessing/build_module_score_metadata.R')",
    "Optional overrides:",
...
score_outputs_manifest <- list(
  module_scores_per_sample_csv = file.path(dir_tables, "module_scores_per_sample.csv"),
...
if (exists("eigengene_scores_df") && nrow(eigengene_scores_df)) {
