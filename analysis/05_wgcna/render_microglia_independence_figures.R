#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/05_wgcna/render_microglia_independence_figures.R
...
SCRIPT_ID <- "analysis/05_wgcna/render_microglia_independence_figures.R"
...
if (length(missing_required)) {
  stop(
    ...
    "\nRun analysis/05_wgcna/test_microglia_neuropil_independence.R first; this script only visualizes its outputs.",
    call. = FALSE
  )
}
...
write_run_manifest(
  ...
  parameters = list(
    dataset = dataset,
    source_tables = "Existing outputs from analysis/05_wgcna/test_microglia_neuropil_independence.R",
    model_refit = FALSE,
