...
#   analysis/08_integration/quantify_candidate_network_position.R and is kept
...
#
# USAGE
#   Rscript analysis/05_wgcna/audit_module_label_coherence.R
#   Rscript analysis/05_wgcna/audit_module_label_coherence.R --dataset neuron_neuropil
#   Rscript analysis/05_wgcna/audit_module_label_coherence.R --dry-run
# Script: analysis/05_wgcna/audit_module_label_coherence.R
# Stage: networks
# Scope: per_dataset
...
SCRIPT_ID <- "analysis/05_wgcna/audit_module_label_coherence.R"
