...
# produced by analysis/05_wgcna/adjudicate_module_labels.R, applies the curated
...
#
# USAGE
#   Rscript analysis/05_wgcna/build_module_label_registry.R
#   Rscript analysis/05_wgcna/build_module_label_registry.R --dry-run
# Script: analysis/05_wgcna/build_module_label_registry.R
# Stage: networks
# Scope: per_dataset
...
SCRIPT_ID <- "analysis/05_wgcna/build_module_label_registry.R"
