# ================================================================
# Script: analysis/wgcna/build_wgcna_modules.R
# Stage: modules_wgcna
...
if (early_has_flag("--dry-run") || tolower(Sys.getenv("PROTEOMICS_DRY_RUN", unset = "")) %in% c("1", "true", "yes")) {
  ...
  dry_run_line("Script", "analysis/wgcna/build_wgcna_modules.R")
  ...
  dry_run_line("Optional DE/GSEA overlap bridge", repo_path("analysis/wgcna", "compare_module_enrichment_overlap.R"), "WARN")
  dry_run_line("Downstream group effects", repo_path("analysis/wgcna", "test_module_phenotypes.R"), "INFO")
  dry_run_line("Downstream biological annotation", repo_path("analysis/wgcna", "annotate_module_microenvironment.R"), "INFO")
  dry_run_line("Downstream interpretable summary", repo_path("analysis/wgcna", "summarize_module_interpretation.R"), "INFO")
...
write_csv_safe(
  reshape2::melt(MEcorr, varnames = c("module", "trait"), value.name = "r") |>
    dplyr::mutate(
      ...
      primary_group_effect_script = "analysis/wgcna/test_module_phenotypes.R",
...
overlap_bridge_script <- repo_path("analysis/wgcna", "compare_module_enrichment_overlap.R")
