# ================================================================
# Script: analysis/wgcna/build_module_identity_contract.R
# Stage: modules_downstream
# Scope: dataset_specific
# Purpose: publish a read-only canonical identity contract for a frozen WGCNA
# Consumes: required data/processed/06_modules_WGCNA/01_WGCNA/<dataset>/wgcna_final_model_state.rds; results/tables/06_modules_WGCNA/01_WGCNA/<dataset>/modules/WGCNA_module_definitions_for_downstream.csv; results/tables/06_modules_WGCNA/01_WGCNA/<dataset>/supermodules/wgcna_module_supermodule_annotation.csv; +7 more; optional results/tables/06_modules_WGCNA/group_effects/<dataset>/; results/tables/06_modules_WGCNA/module_annotation/<dataset>/; results/tables/06_modules_WGCNA/interpretable_summary/<dataset>/; +3 more
# Produces: results/tables/06_modules_WGCNA/identity_contract/<dataset>/; results/source_data/06_modules_WGCNA/identity_contract/<dataset>/; results/reports/06_modules_WGCNA/identity_contract/<dataset>/; +1 more
# Dataset behavior: runs for neuron_neuropil,neuron_soma,microglia according to pipeline.yml and --dataset/PROTEOMICS_DATASET where supported.
# Notes: module system and its provenance-selected Stage 01 supermodules.
# ================================================================
...
if (run$dry_run) {
  dry_run_line("Script", "analysis/wgcna/build_module_identity_contract.R")
