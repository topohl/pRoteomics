...
#   - dataset/source-scoped module score output from analysis/wgcna/score_module_activity.R
# Produces:
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/wgcna/build_module_spatial_networks.R")
...
if (!file.exists(params$module_score_file) && !allow_regex_fallback) {
  stop("Module score output not found: ", params$module_score_file,
       ". Run analysis/wgcna/score_module_activity.R for dataset=", dataset_profile,
