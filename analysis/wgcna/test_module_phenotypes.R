#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/wgcna/test_module_phenotypes.R
# Stage: modules_downstream
# Scope: dataset_specific
# Purpose: canonical identity-contract-based module and supermodule
# Consumes: required data/processed/06_modules_WGCNA/01_WGCNA/<dataset>/wgcna_final_model_state.rds; results/tables/06_modules_WGCNA/identity_contract/<dataset>/WGCNA_entity_identity_contract.csv; results/tables/06_modules_WGCNA/identity_contract/<dataset>/WGCNA_module_supermodule_membership_contract.csv; +1 more; optional none declared in pipeline.yml
# Produces: results/tables/06_modules_WGCNA/group_effects/<dataset>/module_group_effects.csv; results/tables/06_modules_WGCNA/group_effects/<dataset>/supermodule_group_effects.csv; results/tables/06_modules_WGCNA/group_effects/<dataset>/supermodule_composition.csv; +16 more
# Dataset behavior: runs for neuron_neuropil,neuron_soma,microglia according to pipeline.yml and --dataset/PROTEOMICS_DATASET where supported.
# Notes: group-effect modelling. Phase 2 quantitative outputs only.
# ================================================================
