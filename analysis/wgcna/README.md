...
Rscript analysis/wgcna/render_module_go_heatmaps.R --dataset <dataset>
Rscript analysis/wgcna/build_module_identity_contract.R --dataset <dataset>
Rscript analysis/wgcna/test_module_phenotypes.R --dataset <dataset> --level both
Rscript analysis/wgcna/compare_module_enrichment_overlap.R --dataset <dataset>
...
Rscript analysis/wgcna/render_module_figures.R --dataset microglia
Rscript analysis/wgcna/test_microglia_neuropil_independence.R --dataset microglia
Rscript analysis/wgcna/summarize_module_complex_architecture.R --dataset <dataset>
Rscript analysis/wgcna/audit_module_robustness.R --dataset <dataset>
Rscript analysis/wgcna/audit_microglia_module_claims.R --animal-bootstrap 500
Rscript analysis/wgcna/render_microglia_module_figures.R --dataset microglia
Rscript analysis/wgcna/audit_module_claim_readiness.R --dataset microglia
```
...
Rscript analysis/wgcna/score_module_activity.R --dataset microglia
Rscript analysis/wgcna/score_module_activity.R --dataset neuron_soma

$env:PROTEOMICS_MODULE_DEFINITION_SOURCE = "overlap"
Rscript analysis/wgcna/score_module_activity.R --dataset neuron_neuropil
...
```powershell
Rscript analysis/wgcna/build_wgcna_modules.R --dataset microglia
Rscript analysis/wgcna/test_module_phenotypes.R --dataset microglia --level both
Rscript analysis/wgcna/compare_module_enrichment_overlap.R --dataset microglia
Rscript analysis/wgcna/annotate_module_microenvironment.R --dataset microglia
Rscript analysis/wgcna/summarize_module_interpretation.R --dataset microglia
```

```powershell
Rscript analysis/wgcna/build_wgcna_modules.R --dataset neuron_soma
Rscript analysis/wgcna/test_module_phenotypes.R --dataset neuron_soma --level both
Rscript analysis/wgcna/compare_module_enrichment_overlap.R --dataset neuron_soma
Rscript analysis/wgcna/annotate_module_microenvironment.R --dataset neuron_soma
Rscript analysis/wgcna/summarize_module_interpretation.R --dataset neuron_soma
```

```powershell
Rscript analysis/wgcna/build_wgcna_modules.R --dataset neuron_neuropil
Rscript analysis/wgcna/test_module_phenotypes.R --dataset neuron_neuropil --level both
Rscript analysis/wgcna/compare_module_enrichment_overlap.R --dataset neuron_neuropil
Rscript analysis/wgcna/annotate_module_microenvironment.R --dataset neuron_neuropil
Rscript analysis/wgcna/summarize_module_interpretation.R --dataset neuron_neuropil
```
