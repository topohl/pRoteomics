...
# ================================================================
# Script: analysis/wgcna/score_module_activity.R
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/wgcna/score_module_activity.R
# ================================================================
...
if (is_dry_run()) {
  dry_run_line("Script", "analysis/wgcna/score_module_activity.R")
  ...
  dry_run_line("Inference role", "secondary robustness/program scoring; primary WGCNA eigengene group effects come from analysis/wgcna/test_module_phenotypes.R")
...
module_score_role_note <- "Secondary module/program scoring and behavior-coupling layer. Primary WGCNA module and supermodule CON/RES/SUS inference uses eigengene models from analysis/wgcna/test_module_phenotypes.R."
module_score_run_metadata <- tibble::tibble(
  ...
  primary_wgcna_inference_script = "analysis/wgcna/test_module_phenotypes.R",
...
if (length(missing_inputs) > 0) {
  ...
  hint_lines <- c(
    ...
    "- Merged module-score metadata: source('analysis/preprocessing/build_module_score_metadata.R')",
    "Optional overrides:",
