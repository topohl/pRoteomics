#!/usr/bin/env Rscript
# ================================================================
# Script: analysis/wgcna/render_microglia_independence_figures.R
...
if (length(missing_required)) {
  stop(
    ...
    "\nRun analysis/wgcna/test_microglia_neuropil_independence.R first; this script only visualizes its outputs.",
    call. = FALSE
  )
}
...
write_run_manifest(
  ...
  parameters = list(
    dataset = dataset,
    source_tables = "Existing outputs from analysis/wgcna/test_microglia_neuropil_independence.R",
    model_refit = FALSE,
