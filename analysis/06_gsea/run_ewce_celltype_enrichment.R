# ================================================================
# Script: analysis/06_gsea/run_ewce_celltype_enrichment.R
# Stage: enrichment
...
# File contract:
#   - docs/active_script_io_audit.tsv object analysis/06_gsea/run_ewce_celltype_enrichment.R
# ==========================================
...
if (is_dry_run()) {
  ...
  dry_run_line("Script", "analysis/06_gsea/run_ewce_celltype_enrichment.R")
