...
if (is_dry_run()) {
    ...
    dry_run_line("Script", "analysis/preprocessing/map_protein_identifiers.R")
    ...
    if (!dir.exists(raw_dir) || length(csv_files) == 0) {
        dry_run_line("Required upstream step", "Rscript analysis/preprocessing/extract_protigy_contrasts.R without --dry-run")
    }
