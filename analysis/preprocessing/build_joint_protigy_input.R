...
# Script: analysis/preprocessing/build_joint_protigy_input.R
...
runtime <- list(script = "analysis/preprocessing/build_joint_protigy_input.R", stage = "joint_qc_preprocessing", dataset = "global", args = commandArgs(trailingOnly = TRUE), dry_run = is_dry_run(), started_at = Sys.time())
