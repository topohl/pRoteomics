...
#   analysis/spatial_validation/build_protein_spatial_atlas.R are read and tabulated
...
#
# USAGE
#   Rscript analysis/spatial_validation/audit_stress_identity_robustness.R
#   Rscript analysis/spatial_validation/audit_stress_identity_robustness.R --dry-run
...
SCRIPT_ID <- "analysis/spatial_validation/audit_stress_identity_robustness.R"
