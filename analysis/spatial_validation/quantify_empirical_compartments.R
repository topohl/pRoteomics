...
#
# USAGE
#   Rscript analysis/spatial_validation/quantify_empirical_compartments.R
#   Rscript analysis/spatial_validation/quantify_empirical_compartments.R --dry-run
# Script: analysis/spatial_validation/quantify_empirical_compartments.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/spatial_validation/quantify_empirical_compartments.R"
