...
#
# USAGE
#   Rscript analysis/spatial_validation/build_protein_spatial_atlas.R
#   Rscript analysis/spatial_validation/build_protein_spatial_atlas.R --dry-run
...
SCRIPT_ID <- "analysis/spatial_validation/build_protein_spatial_atlas.R"
...
#
# Produced by analysis/spatial_validation/audit_stress_identity_robustness.R, which runs
