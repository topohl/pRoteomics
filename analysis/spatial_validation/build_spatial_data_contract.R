...
#
# USAGE
#   Rscript analysis/spatial_validation/build_spatial_data_contract.R
#   Rscript analysis/spatial_validation/build_spatial_data_contract.R --dry-run
# Script: analysis/spatial_validation/build_spatial_data_contract.R
# Stage: networks
# Scope: per_dataset
...
SCRIPT_ID <- "analysis/spatial_validation/build_spatial_data_contract.R"
