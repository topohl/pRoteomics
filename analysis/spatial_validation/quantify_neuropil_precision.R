...
#
# USAGE
#   Rscript analysis/spatial_validation/quantify_neuropil_precision.R
# Script: analysis/spatial_validation/quantify_neuropil_precision.R
# Stage: networks
# Scope: global
...
SCRIPT_ID <- "analysis/spatial_validation/quantify_neuropil_precision.R"
