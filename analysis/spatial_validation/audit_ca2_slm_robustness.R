...
#
# USAGE
#   Rscript analysis/spatial_validation/audit_ca2_slm_robustness.R
#   Rscript analysis/spatial_validation/audit_ca2_slm_robustness.R --dry-run
...
SCRIPT_ID <- "analysis/spatial_validation/audit_ca2_slm_robustness.R"
