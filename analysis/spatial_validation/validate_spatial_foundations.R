...
#
# USAGE
#   Rscript analysis/spatial_validation/validate_spatial_foundations.R
...
SCRIPT_ID <- "analysis/spatial_validation/validate_spatial_foundations.R"
...
add("no_wgcna_state_changes", TRUE,
    if (!touches("analysis/wgcna/build_wgcna_modules.R") &&
