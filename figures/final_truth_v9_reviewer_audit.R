...
vl <- rbind(
 ...
 V(5, "pathway examples were chosen after seeing the result", "partially",
 ...
 V(9, "microglia-enriched ROI is treated as cell-intrinsic microglia", "yes",
   "every label and legend says microglia-enriched ROI or local microenvironment",
   "the compartment is an enriched measurement context, not sorted cells",
   "already stated", "would need sorted or single-cell microglia"),
