...
#
# ED2, the WGCNA figure and ED7 are deliberately absent. Their defects are
# recorded in manuscript/extended_data_promotion_audit.csv and nothing was
# substituted for them.
source(file.path("R", "paths.R"))
source(repo_path("R", "manuscript_figure_utils.R"))

for (fig in c("ED_01", "ED_03", "ED_06", "ED_08")) {
