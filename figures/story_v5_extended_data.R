#!/usr/bin/env Rscript
# Story-v5. Sixth parallel layer; canonical and Parts 16-19 are untouched.
...
Sys.setenv(PROTEOMICS_SCRIPT_ID = "figures/story_v5_extended_data.R")
args <- commandArgs(trailingOnly = TRUE)
res <- s5e_build("extended_data", dry_run = "--dry-run" %in% args || is_dry_run())
if (!is.null(res)) {
  cat("\n===== Story-v5 extended_data =====\n")
