...
# Nature-style v2 candidate Figure 03 entry point.
#
...
Sys.setenv(PROTEOMICS_SCRIPT_ID = "figures/nature_v2_figure_03.R")
args <- commandArgs(trailingOnly = TRUE)
res <- nv_build("figure_03", dry_run = "--dry-run" %in% args || is_dry_run())
if (!is.null(res)) {
  cat("\n===== Nature-style v2 Figure 03 =====\n")
