#!/usr/bin/env Rscript
# Story-v4 candidate Figure 02. Fifth parallel layer; canonical, Part-16,
...
Sys.setenv(PROTEOMICS_SCRIPT_ID = "figures/story_v4_figure_02.R")
args <- commandArgs(trailingOnly = TRUE)
res <- s4e_build("figure_02", dry_run = "--dry-run" %in% args || is_dry_run())
if (!is.null(res)) {
  cat("\n===== Story-v4 Figure 02 =====\n")
