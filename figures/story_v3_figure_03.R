...
# Story-v3 candidate Figure 03. Fourth parallel layer; canonical, Part-16 and
...
Sys.setenv(PROTEOMICS_SCRIPT_ID = "figures/story_v3_figure_03.R")
args <- commandArgs(trailingOnly = TRUE)
res <- sv_build("figure_03", dry_run = "--dry-run" %in% args || is_dry_run())
if (!is.null(res)) {
  cat("\n===== Story-v3 Figure 03 =====\n")
