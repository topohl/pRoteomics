...
Sys.setenv(PROTEOMICS_SCRIPT_ID = "figures/nature_final_v7_figure_02.R")
args <- commandArgs(trailingOnly = TRUE)
res <- s7e_build("figure_02", dry_run = "--dry-run" %in% args || is_dry_run())
if (!is.null(res)) {
  cat("\n===== Nature-final v7 figure_02 =====\n")
