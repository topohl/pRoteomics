...
sps_evidence_dependence_registry <- function() {
  rows <- list(
    c("con_spatial_identity",
      "analysis/differential_abundance/validate_control_spatial_identity.R",
    ...
    c("bilateral_spatial_validation",
      "analysis/spatial_validation/quantify_bilateral_spatial_identity.R",
    ...
    c("cross_hemisphere_compartment_validation",
      "analysis/spatial_validation/quantify_empirical_compartments.R",
    ...
    c("wgcna_module_identity",
      "analysis/wgcna/build_wgcna_modules.R (frozen membership)",
    ...
    c("wgcna_bilateral_validation",
      "analysis/spatial_validation/quantify_module_bilateral_identity.R",
    ...
    c("ewce_differential",
      "analysis/enrichment/run_ewce_celltype_enrichment.R (Differential arm)",
    ...
    c("ewce_module_annotation",
      "analysis/spatial_validation/annotate_module_celltypes.R",
