...
sps_evidence_dependence_registry <- function() {
  rows <- list(
    ...
    c("bilateral_spatial_validation",
      "11_spatial_systems/02_bilateral_spatial_identity.R",
    ...
    c("cross_hemisphere_compartment_validation",
      "11_spatial_systems/03_bilateral_empirical_compartment.R",
    ...
    c("wgcna_module_identity",
      "06_modules_WGCNA/01_WGCNA.r (frozen membership)",
    ...
    c("wgcna_bilateral_validation",
      "11_spatial_systems/04_wgcna_module_bilateral.R",
    ...
    c("ewce_differential",
      "05_celltype_enrichment_EWCE/01_EWCE_E9.r (Differential arm)",
    ...
    c("ewce_module_annotation",
      "11_spatial_systems/05_wgcna_module_celltype_annotation.R",
