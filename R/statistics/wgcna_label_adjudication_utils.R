...
wla_consumer_migration_plan <- function() {
  rows <- list(
    ...
    c("analysis/08_integration/09_wgcna_sus_res_network_position.R",
    ...
    c("analysis/05_wgcna/14_wgcna_label_coherence_audit.R",
    ...
    c("analysis/05_wgcna/15_wgcna_label_adjudication.R",
      ...
      "Do not migrate."),
    c("analysis/08_integration/05_manuscript_figure3_wgcna_protein_zoom.R",
    ...
    c("analysis/08_integration/04_wgcna_circular_atlas.R",
    ...
    c("analysis/05_wgcna/08_wgcna_publication_figures.R",
    ...
    c("analysis/09_publication_exports/07_make_biological_claims_table.R",
    ...
    c("analysis/05_wgcna/07_wgcna_interpretable_summary.r",
