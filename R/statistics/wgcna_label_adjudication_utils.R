...
wla_consumer_migration_plan <- function() {
  rows <- list(
    ...
    c("analysis/08_integration/quantify_candidate_network_position.R",
    ...
    c("analysis/05_wgcna/audit_module_label_coherence.R",
    ...
    c("analysis/05_wgcna/adjudicate_module_labels.R",
      ...
      "Do not migrate."),
    c("analysis/08_integration/export_module_protein_zoom_source_data.R",
    ...
    c("analysis/08_integration/render_module_circular_atlas.R",
    ...
    c("analysis/05_wgcna/render_module_figures.R",
    ...
    c("analysis/09_publication_exports/build_biological_claims_table.R",
    ...
    c("analysis/05_wgcna/summarize_module_interpretation.R",
