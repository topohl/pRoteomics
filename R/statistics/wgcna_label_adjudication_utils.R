...
wla_consumer_migration_plan <- function() {
  rows <- list(
    ...
    c("10_biological_integration/09_wgcna_sus_res_network_position.R",
    ...
    c("06_modules_WGCNA/14_wgcna_label_coherence_audit.R",
    ...
    c("06_modules_WGCNA/15_wgcna_label_adjudication.R",
      ...
      "Do not migrate."),
    c("10_biological_integration/05_manuscript_figure3_wgcna_protein_zoom.R",
    ...
    c("10_biological_integration/04_wgcna_circular_atlas.R",
    ...
    c("06_modules_WGCNA/08_wgcna_publication_figures.R",
    ...
    c("09_export_pride_journal/07_make_biological_claims_table.R",
    ...
    c("06_modules_WGCNA/07_wgcna_interpretable_summary.r",
